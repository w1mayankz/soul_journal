          ...
          <div className="mt-4 border-t border-neutral-800/60 pt-6 flex-1 overflow-y-auto pr-1 scrollbar-hide">
            ...
            {step === 1 && (
              <div className="flex flex-col items-center animate-in fade-in slide-in-from-right-4 duration-300">
                <span className="mb-4 rounded-md bg-[#141414] px-2.5 py-1 text-[12px] font-semibold text-neutral-400">
                  1/3
                </span>
                <h2 className="mb-2 text-[20px] font-semibold tracking-tight text-white">
                ...
                <button 
                  onClick={() => setStep(2)}
                  className="group flex w-full flex-col items-center rounded-2xl border border-neutral-800/60 bg-[#111] p-6 transition-colors hover:bg-[#141414] active:scale-[0.98] outline-none"
                >
            ...
            {step === 2 && (
              <div className="flex flex-col animate-in fade-in slide-in-from-right-4 duration-300 pb-4">
                ...
                <button 
                  onClick={() => setStep(1)}
                  className="mb-5 flex w-fit items-center gap-2 rounded-lg bg-[#141414] px-3 py-1.5 text-[13px] font-semibold text-white transition-colors hover:bg-[#1A1A1A] active:scale-95 outline-none"
                >
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input 
                      ...
                      className="w-full rounded-xl border border-transparent bg-[#141414] px-4 py-3.5 text-[14px] font-medium text-white transition-colors placeholder:text-neutral-600 focus:border-neutral-700 outline-none"
                    />
                  </div>
                  ...
                  <div className="mt-2">
                    <button 
                      ...
                      className="flex items-center gap-2 text-[14px] font-medium text-neutral-300 hover:text-white transition-colors outline-none"
                    >
                      <ArrowDown01Icon size={16} className={`transition-transform duration-200 ${isAdvancedOpen ? 'rotate-180' : ''}`} /> 
                      Advanced options
                    </button>
                  </div>
                ...
                <div className="mt-8 flex items-center justify-end gap-3 pt-4">
                  ...
                  <button 
                    onClick={() => setIsOpen(false)} // Dummy functional close for now
